...
#ifdef __DATE__
#ifdef __TIME__
    PRINTF("\r\n=== Digital Key Car Anchor CS Build Info ===\r\n");
    PRINTF("Build Date: %s\r\n", __DATE__);
    PRINTF("Build Time: %s\r\n", __TIME__);
    PRINTF("==========================================\r\n\r\n");
#endif
...
void BleApp_ConnectionCallback (deviceId_t peerDeviceId, gapConnectionEvent_t* pConnectionEvent)
{
    ...
    switch (pConnectionEvent->eventType)
    {
        ...
        case gConnEvtConnected_c:
        {
            ...
            /* Initialize RSSI monitoring for connected device */
        ...
        case gConnEvtDisconnected_c:
        {
            ...
            /* Stop RSSI monitoring for disconnected device */
        ...
        {
            /* RSSI read - forward to RSSI integration module */
            RssiIntegration_UpdateRssi(peerDeviceId, pConnectionEvent->eventData.rssi_dBm);
        }
        break;
